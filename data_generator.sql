...
insert into dm.b_cust_acct (customer_id, account_number, customer_role)
values 
(10001, 11456789, 'owner'),
(10001, 13555562, 'owner'),
(10002, 65678754, 'owner'),
(10003, 98875556, 'owner'),
(20001, 59949923, 'owner'),
(20001, 20766825, 'owner'),
(20001, 20068630, 'owner'),
(20002, 13241579, 'owner'),
(20002, 61833390, 'owner'),
(20003, 84642257, 'owner'),
(20004, 23512496, 'owner'),
(20004, 82501707, 'owner'),
(20004, 79299653, 'owner'),
(20004, 47523436, 'owner'),
(30001, 91697692, 'owner'),
(30001, 19222816, 'owner'),
(30001, 11348330, 'owner'),
(30002, 33516327, 'owner'),
(30003, 38510071, 'owner'),
(40001, 84039601, 'owner'),
(40001, 97007074, 'owner'),
(40002, 67224356, 'owner'),
(40002, 49564892, 'owner') ;
